...
const StartExam = () => {
    ...
    const startRecordingAnswer = () => {
        ...
        recognition.onresult = (event) => {
            ...
            if (finalTranscript) {
                ...
                console.log("Final Answer buffer updated: ", answerBuffer);
        ...
        recognition.onend = () => {
            console.log("Recognition ended. isReadyToRecord:", isReadyToRecord);
            if (isReadyToRecord) {
    ...
    return (
        <section className="startExamSec" id='startExamSec'>
